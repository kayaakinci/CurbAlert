...
class L515_object_detection:
    def __init__(self, model_path="/content/drive/MyDrive/stairs_detection_output/best.pt", confidence_threshold=0.5, camera_id='/dev/video6'):
        self.confidence_threshold = confidence_threshold
...
if __name__ == "__main__":
    # Create hazard detection object
    detector = L515_object_detection(
        model_path="path/to/your/fine-tuned/model.pt",  # Update with your model path
        confidence_threshold=0.5,
        camera_id="/dev/video6"  # Replace with your actual camera serial number or ID
    )
